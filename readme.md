...
![MCP Marketplace User Review Rating Badge](http://www.deepnlp.org/api/marketplace/svg?sonnylazuardi/cursor-talk-to-figma-mcp)|[Reviews](http://www.deepnlp.org/store/ai-agent/mcp-server/pub-sonnylazuardi/cursor-talk-to-figma-mcp)|[GitHub](https://github.com/AI-Agent-Hub/mcp-marketplace)|[Doc](http://www.deepnlp.org/doc/mcp_marketplace)|[MCP Marketplace](http://www.deepnlp.org/store/ai-agent/mcp-server)
...
result_q = mcpm.search(query="cursor talk to figma mcp", mode="list", page_id=0, count_per_page=100, config_name="deepnlp") # search server by category choose various endpoint
result_id = mcpm.search(id="sonnylazuardi/cursor-talk-to-figma-mcp", mode="list", page_id=0, count_per_page=100, config_name="deepnlp")      # search server by id choose various endpoint 
tools = mcpm.list_tools(id="sonnylazuardi/cursor-talk-to-figma-mcp", config_name="deepnlp_tool")
